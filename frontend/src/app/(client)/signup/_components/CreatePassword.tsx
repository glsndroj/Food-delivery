...
export function CreatePassword () {
    return (
        <div className="flex gap-24 w-full h-screen items-center justify-center">
            ...
            <input className="border border-gray-300 rounded-md py-1" type="password" placeholder="Password" />
            <input className="border border-gray-300 rounded-md py-1" type="password" placeholder="Confirm" />
